...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-repeat-row', __webpack_require__(3));
  Vue.component('detail-repeat-row', __webpack_require__(6));
  Vue.component('form-repeat-row', __webpack_require__(9));
});
