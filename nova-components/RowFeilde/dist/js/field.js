...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-row-feilde', __webpack_require__(3));
  Vue.component('detail-row-feilde', __webpack_require__(6));
  Vue.component('form-row-feilde', __webpack_require__(9));
});
