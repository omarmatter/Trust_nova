...
Nova.booting(function (Vue, router, store) {
  Vue.component('chatticket', __webpack_require__(2));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        addSend: function addSend() {
            ...
            axios.post('/nova-vendor/chatticket/storeReply/' + this.id, message).then(function (response) {
                _this.replies.push(response.data.data);
            });
        }
    }
...
var render = function() {
  ...
  return _c("div", { staticClass: "card mb-6 py-3 px-6" }, [
    _c(
      "div",
      { attrs: { id: "replies" } },
      _vm._l(_vm.replies, function(reply, index) {
        return _c("div", { staticClass: "container" }, [
          _c("img", {
            ...
            attrs: {
              src:
                "https://www.drpaulcohen.com/wp-content/uploads/2016/11/no-photo.jpg",
              alt: "Avatar"
            }
          }),
          _vm._v(" "),
          _c("p", { domProps: { innerHTML: _vm._s(reply.message) } })
        ])
      }),
      0
    ),
    ...
    _c(
      "button",
      {
        staticClass: "btn btn-default bg-primary",
        on: {
